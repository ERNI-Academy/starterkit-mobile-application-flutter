...
typedef IsarTxnCallback<T, TResult> = TResult Function(IsarCollection<Object, T> collection);
...
abstract class IsarLocalDataSource<T extends DataObject> implements LocalDataSource<T> {
  ...
  Future<T?> get(Object id) async {
    final T? object = await readUsing((IsarCollection<Object, T?> collection) {
  ...
  Future<Iterable<T>> getAll() async {
    final Iterable<T> objects = await readUsing((IsarCollection<Object, T> collection) {
  ...
  Future<void> addOrUpdate(T object) async {
    await writeUsing((IsarCollection<Object, T> collection) {
  ...
  Future<void> writeUsing(IsarTxnCallback<T, void> callback) async {
    final Isar isar = await _getIsar();
    isar.write<void>((Isar i) => callback(i.collection<Object, T>()));
  }
